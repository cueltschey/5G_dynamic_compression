...
public:
  IqConverter(){};
  std::vector<d_compression::cbf16_t> toIq(const std::vector<uint8_t>& data);
  std::vector<uint8_t> fromIq(const std::vector<d_compression::cbf16_t>& iqSamples);
  std::vector<uint8_t> serializeIq(const std::vector<d_compression::cbf16_t>& iqSamples);
  std::vector<d_compression::cbf16_t> deserializeIq(const std::vector<uint8_t>& serializedData);
};
